...
public interface EatingHabitRepository extends JpaRepository<EatingHabit, Long> {
    ...
    List<Integer> findTotalTimeTopByDateAndChildrenNameOrderByCreatedAtDesc(String date, String childName, String phoneNumber);
    ...
    List<Integer> findBitCountWithMouthTopByDateAndChildrenNameOrderByCreatedAtDesc(String date, String childName, String phoneNumber);
